...
<div class="topnav">
  ...
  <a class="active" href="login.jsp" class="w3-button w3-bar-item">LogIn</a>
...
<div class="container">
  <form action="loginControl.jsp" method="post">
    <div class="row">
      ...
      <div class="col">
        ...
        <h2 style="align: centre">Login Form</h2>
        <input type="email" name="email" placeholder="zxy@email.com" required>
  ...
  <div class="row">
    ...
    <div class="col">
      <a href="forgotPassword.jsp" style="color:white" class="btn">Forgot password?</a>
    </div>
  </div>
</div>-->
